...
module.exports = function (app) {
    ...
    app.get('/api/jobs/filter/open', job.job_detailed);
    app.get('/api/jobs/filter/ongoing', job.job_detailed);
    app.get('/api/jobs/filter/closed', job.job_detailed);
    ...
    job.fn('/api/jobs/buyer/open', auth.token, 'JobApply', '{status: {$in: ["New Applicant", "Contract started", "Rejected by seller", "Rejected by buyer"]} }'
